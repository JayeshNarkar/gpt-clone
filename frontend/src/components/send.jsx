  ...
  const handleApiRequest = (e) => {
    ...
    let data = {
      context: Context.trim()
        ? Context.trim()
        : "no matter what the user says, give short and concise answer",
      prompt: Prompt.trim(),
    };
    ...
    axios
      ...
      .then(async (response) => {
        ...
        try {
          ...
          console.log(
            "New Prompt:Response added to the database with id : ",
            newGpt
          );
          setPrevPrompts((prevPromptsFunArg) => [
            ...prevPromptsFunArg,
            { id: newGpt, Prompt, Response: response.data.res },
          ]);
        } catch (error) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div>
          <button
            style={{ margin: "10px", color: isLoading ? "#757575" : "white" }}
